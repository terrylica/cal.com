  ...
  describe("Dynamic event type slots", () => {
    ...
    it("should get slots in UTC by usernames", async () => {
      return request(app.getHttpServer())
        .get(
          `/v2/slots?usernames=${orgProfileOne.username},${orgProfileTwo.username}&organizationSlug=${organization.slug}&start=2026-09-07&end=2026-09-11&duration=60`
        )
    ...
    it("should get slots in specified timezone and in specified duration by usernames", async () => {
      return request(app.getHttpServer())
        .get(
          `/v2/slots?usernames=${orgProfileOne.username},${orgProfileTwo.username}&organizationSlug=${organization.slug}&start=2026-09-07&end=2026-09-11&duration=60&timeZone=Europe/Rome`
        )
        .set(CAL_API_VERSION_HEADER, VERSION_2024_09_04)
        .expect(200)
        .then(async (response) => {
