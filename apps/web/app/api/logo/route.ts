...
const logoDefinitions: Record<LogoType, LogoTypeDefinition> = {
  ...
  icon: {
    ...
    staticPath: LOGO_ICON,
    source: "appIconLogo",
  },
  "favicon-16": {
    fallback: `${WEBAPP_URL}${FAVICON_16}`,
    staticPath: FAVICON_16,
    w: 16,
    h: 16,
    source: "appIconLogo",
  },
  ...
  "android-chrome-192": {
    ...
    staticPath: ANDROID_CHROME_ICON_192,
    w: 192,
    h: 192,
    source: "appLogo",
  },
  "android-chrome-256": {
    ...
    staticPath: ANDROID_CHROME_ICON_256,
    w: 256,
    h: 256,
    source: "appLogo",
  },
...
function shouldUseDefaultLogo(subdomain: string | undefined): boolean {
  return IS_SELF_HOSTED || !subdomain || SYSTEM_SUBDOMAINS.includes(subdomain);
}
