...
import type { SettingsSection } from "~/settings/home/settings-home-data";
...
export default function SettingsHomeView() {
  ...
  return (
    <div className="py-2">
      <div className="mb-8">
        <h1 className="font-cal font-semibold text-2xl text-emphasis">
          {t("settings")}
        </h1>
      </div>
...
function SectionGroup({
  ...
  return (
    <div className="mb-8">
      <h2 className="mb-4 font-semibold text-base text-emphasis">
        ...
        {section.items.map((item) => (
          ...
          >
            ...
            <div className="min-w-0">
              ...
              <p className="mt-0.5 text-subtle text-xs leading-relaxed">
