      ...
      <div className="border-subtle bg-cal-muted rounded-lg border p-1">
        ...
        <div className="border-subtle bg-default rounded-lg border p-5">
          <FormBuilder
            ...
            unifySystemPhoneFields={formMethods.watch("metadata.unifySystemPhoneFields") ?? true}
            onUnifySystemPhoneFieldsChange={(value) => {
              formMethods.setValue("metadata.unifySystemPhoneFields", value, { shouldDirty: true });
            }}
          />
        </div>
      </div>
