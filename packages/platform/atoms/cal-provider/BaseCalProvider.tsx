...
import deTranslations from "@calcom/config/i18n/locales/de/common.json";
import enTranslations from "@calcom/config/i18n/locales/en/common.json";
import esTranslations from "@calcom/config/i18n/locales/es/common.json";
import frTranslations from "@calcom/config/i18n/locales/fr/common.json";
import itTranslations from "@calcom/config/i18n/locales/it/common.json";
import nlTranslations from "@calcom/config/i18n/locales/nl/common.json";
import ptBrTranslations from "@calcom/config/i18n/locales/pt-BR/common.json";
