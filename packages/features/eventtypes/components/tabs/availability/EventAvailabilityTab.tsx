...
// Type for host schedules query - can be either trpc query or custom hook
export type HostSchedulesQueryType =
...
// Inlined TeamMember type to avoid web import
...
export type EventAvailabilityTabBaseProps = {
  isTeamEvent: boolean;
};
