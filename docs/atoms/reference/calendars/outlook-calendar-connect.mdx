...
Below code snippet can be used to render the Outlook calendar connect button
...
For a demonstration of the Outlook calendar connect integration, please refer to the video below.
...
We offer all kinds of customizations to the Outlook calendar connect via props. Below is a list of props that can be passed to the Outlook calendar connect.
<p></p>
