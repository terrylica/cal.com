...
For more information on accepting payments and how to combine payment form with Stripe, see the [Payment Form documentation](/atoms/reference/payments/payment-form).
