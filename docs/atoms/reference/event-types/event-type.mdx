...
```
then you have to pass the access token of this managed user to the [CalProvider](https://cal.com/docs/atoms/reference/auth/cal-provider) to then finally be able to
