...
We created an event type for user with custom text and select fields. Name and email fields are created by default. Here is the request:
...
Let's say you want that when someone is trying to book one of your users that the
