...
2. Add an OAuth client.
    ...
    3. Booking, reschedule and cancel URLs: URLs of pages where users land after a successful booking or if they want to reschedule or cancel a booking. We will pass information in the URL when redirecting to your pages and you will use our hooks and components to implement the pages. See [this guide](/atoms/guides/booking-redirects).
...
<Warning>
Managed users do not get a public cal.com page like normal cal.com users do. If you create a managed user, they won't have a cal.com/managed-user page. Instead, the managed user's public page will be at your-platform.com/managed-user where you fetch event types using our API or React hooks and display them.
</Warning>
